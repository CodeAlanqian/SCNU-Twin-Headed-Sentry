...
private:
  ...
  rclcpp::AsyncParametersClient::SharedPtr detector_param_client_first;
  rclcpp::AsyncParametersClient::SharedPtr detector_param_client_second;
  ...
  rclcpp::Publisher<auto_aim_interfaces::msg::FromSentry>::SharedPtr sentry_pub_;

  // From sentry
  auto_aim_interfaces::msg::FromSentry sentry_msg_;
